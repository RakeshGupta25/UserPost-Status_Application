package com.springsecurity.group.controller;

import com.springsecurity.group.entity.Post;
import com.springsecurity.group.entity.PostStatus;
import com.springsecurity.group.repository.PostRepository;
...
public class PostController {
    ...
    public String createPost(@RequestBody Post post, Principal principal) {    	
       ...
       // System.out.println(principal.getName()+"_________");
        postRepository.save(post);
       
        //return principal.getName() + " Your post published successfully , Required ADMIN/MODERATOR Action !";
        return post.getUserName() + " Your post published successfully , Required ADMIN/MODERATOR Action !";
    }
